...
from models import (
    ...
    TemplatesGetResponse1,
    TemplatesGetResponse2,
    TemplatesGetResponse3,
    TemplatesGetResponse4,
    TemplatesGetResponse5,
    TemplatesOutputPostResponse,
    TemplatesOutputPostResponse1,
    TemplatesOutputPostResponse2,
    TemplatesOutputPostResponse3,
    TemplatesOutputPostResponse4,
    TemplatesOutputPostResponse5,
    TemplatesPostResponse,
    TemplatesPostResponse1,
    TemplatesPostResponse2,
    TemplatesPostResponse3,
    TemplatesPostResponse4,
    TemplatesPostResponse5,
    TemplatesTemplateIdCopyPostResponse,
    TemplatesTemplateIdCopyPostResponse1,
    TemplatesTemplateIdCopyPostResponse2,
    TemplatesTemplateIdCopyPostResponse3,
    TemplatesTemplateIdCopyPostResponse4,
    TemplatesTemplateIdCopyPostResponse5,
    TemplatesTemplateIdDeleteResponse,
    TemplatesTemplateIdDeleteResponse1,
    TemplatesTemplateIdDeleteResponse2,
    TemplatesTemplateIdDeleteResponse3,
    TemplatesTemplateIdDeleteResponse4,
    TemplatesTemplateIdDeleteResponse5,
    TemplatesTemplateIdEditorPostRequest,
    TemplatesTemplateIdEditorPostResponse,
    TemplatesTemplateIdEditorPostResponse1,
    TemplatesTemplateIdEditorPostResponse2,
    TemplatesTemplateIdEditorPostResponse3,
    TemplatesTemplateIdEditorPostResponse4,
    TemplatesTemplateIdEditorPostResponse5,
    TemplatesTemplateIdGetResponse,
    TemplatesTemplateIdGetResponse1,
    TemplatesTemplateIdGetResponse2,
    TemplatesTemplateIdGetResponse3,
    TemplatesTemplateIdGetResponse4,
    TemplatesTemplateIdGetResponse5,
    TemplatesTemplateIdOutputPostResponse,
    TemplatesTemplateIdOutputPostResponse1,
    TemplatesTemplateIdOutputPostResponse2,
    TemplatesTemplateIdOutputPostResponse3,
    TemplatesTemplateIdOutputPostResponse4,
    TemplatesTemplateIdOutputPostResponse5,
    TemplatesTemplateIdPutResponse,
    TemplatesTemplateIdPutResponse1,
    TemplatesTemplateIdPutResponse2,
    TemplatesTemplateIdPutResponse3,
    TemplatesTemplateIdPutResponse4,
    TemplatesTemplateIdPutResponse5,
    WorkspacesWorkspaceIdDeleteResponse,
    WorkspacesWorkspaceIdDeleteResponse1,
    WorkspacesWorkspaceIdDeleteResponse2,
    WorkspacesWorkspaceIdDeleteResponse3,
    WorkspacesWorkspaceIdDeleteResponse4,
    WorkspacesWorkspaceIdDeleteResponse5,
    WorkspacesWorkspaceIdGetResponse,
    WorkspacesWorkspaceIdGetResponse1,
    WorkspacesWorkspaceIdGetResponse2,
    WorkspacesWorkspaceIdGetResponse3,
    WorkspacesWorkspaceIdGetResponse4,
    WorkspacesWorkspaceIdGetResponse5,
)
...
app = MCPProxy(
    ...
    version='3.1.1',
    servers=[{'url': 'https://us1.pdfgeneratorapi.com/api/v3'}],
)
...
def create_template(body: TemplateDefinitionNew):
    """
    Create template
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def merge_templates(
    ...
    format: Optional[Format4] = 'pdf',
    output: Optional[Output] = 'base64',
    body: BatchData = ...,
):
    """
...
def delete_template(template_id: int = Query(..., alias='templateId')):
    """
    Delete template
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def get_template(template_id: int = Query(..., alias='templateId')):
    """
    Get template
    """
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def update_template(
    template_id: int = Query(..., alias='templateId'), body: TemplateDefinitionNew = ...
):
    """
    Update template
    """
...
def copy_template(
    template_id: int = Query(..., alias='templateId'), name: Optional[str] = None
):
    """
    Copy template
    """
...
def get_editor_url(
    ...
    body: TemplatesTemplateIdEditorPostRequest = ...,
):
    """
    Open editor
    """
